...
static bool
higher_priority (const struct list_elem *a_, const struct list_elem *b_, void *aux UNUSED);
*/
...
/* Creates a new kernel thread named NAME with the given initial
   ...
   before thread_create() returns.  Contrariwise, the originalinal
...
/* Transitions a blocked thread T to the ready-to-run state.
   This is an error if T is not blocked.  (Use 
   thread_yield() to
 ...
 */
void thread_set_check_wakeup(void)
{
  /* check threads in sleep queue by their sleepers_ticks 
