...
*/ 
 ...
 // list_insert_ordered(&sleep_list, &thread_current()->elem,cmp_waketick, NULL);
...
void thread_block_till (int64_t ticks)
{
  ...
  cur->waketick = ticks + timer_ticks ();
